sap.ui.define([
	...
	return BaseController.extend("req.customer.codan.controller.Search", {
		 ...
		 */
		onSearch: function () {
			var searchString = this.getModel("worklistView").getProperty("/searchText");
		...
		onSelect: function (event) {
			this.getRouter().navTo("existingCustomer", {
		...
		_showCompanySelectDialog: function () {
			...
			if (!this._oCompanySelectDialog) {
				this._oCompanySelectDialog = sap.ui.xmlfragment("req.customer.codan.fragments.CompanySelect", this);
